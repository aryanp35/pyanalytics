# -*- coding: utf-8 -*-
"""
Created on Sun Sep  1 21:34:05 2019
...
newAttendance2['Dattnd'].index.max()
newAttendance2['Dattnd'].resample('M').sum(min_count=18)

#min rows=5  min classes held during the month duration
